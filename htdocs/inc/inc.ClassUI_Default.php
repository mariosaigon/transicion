...
class UI_Default {
	...
	function __calendarNavigationBar($d){ /* {{{ */
		...
		//Modificado por Mario para que no puedan añadir eventos na mas que administradors
		if ($user->isAdmin()) echo "<li><a href=\"../out/out.AddEvent.php\">".getMLText("add_event")."</a></li>\n";
		echo "</ul>\n";
		return;
