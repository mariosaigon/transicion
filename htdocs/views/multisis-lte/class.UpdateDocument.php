...
<?php
	...
	function show() { /* {{{ */
		...
		if($user->isAdmin())
		{
			$this->htmlStartPage("Actualizar documento publicado", "skin-blue sidebar-mini sidebar-collapse");
		}
		else
		{
			$this->htmlStartPage("Actualizar documento publicado ", "skin-blue layout-top-nav");
		}
